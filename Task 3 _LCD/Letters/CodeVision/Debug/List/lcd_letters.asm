...
;#include <delay.h>
;
;unsigned char Letters[] = {'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w',' ...
...
_main:
; .FSTART _main
; 0000 0010 DDRD=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(0)
	OUT  0x11,R30
; 0000 0011 PORTD=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	OUT  0x12,R30
; 0000 0012 
...
_0x8:
	...
	CPC  R5,R31
	BRGE _0x9
; 0000 0018             lcd_putchar(Letters[x]);
