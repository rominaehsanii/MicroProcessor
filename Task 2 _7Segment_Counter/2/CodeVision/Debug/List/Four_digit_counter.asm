...
; .FSTART _timer0_ovf_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0015            PORTD = SevenSegment[Counter[i]];
	...
	LD   R30,X
	LDI  R31,0
	SUBI R30,LOW(-_SevenSegment)
	SBCI R31,HIGH(-_SevenSegment)
	LD   R30,Z
	OUT  0x12,R30
; 0000 0016                 i++;
	MOVW R30,R4
...
; .FSTART _timer1_ovf_isr
	ST   -Y,R30
; 0000 0021         TCNT1H=0xFF;
	LDI  R30,LOW(255)
	OUT  0x2D,R30
; 0000 0022         TCNT1L=0xF0;
	LDI  R30,LOW(240)
	OUT  0x2C,R30
; 0000 0023 }
	LD   R30,Y+
...
; .FSTART _main
; 0000 0029 
; 0000 002A DDRD=0b11111111;
	LDI  R30,LOW(255)
	OUT  0x11,R30
; 0000 002B PORTD=0b00000000;
	LDI  R30,LOW(0)
	OUT  0x12,R30
; 0000 002C DDRC=0b11111111;
	LDI  R30,LOW(255)
	OUT  0x14,R30
; 0000 002D PORTC=0b11101111;
	LDI  R30,LOW(239)
	OUT  0x15,R30
; 0000 002E TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(5)
	OUT  0x39,R30
; 0000 002F TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	OUT  0x33,R30
...
; 0000 0035 TCNT1L=0xF0;
	...
	OUT  0x2C,R30
; 0000 0036 
; 0000 0037 MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(0)
	OUT  0x35,R30
